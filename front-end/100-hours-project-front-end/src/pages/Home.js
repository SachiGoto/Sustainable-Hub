...
const Home = () => {
  return (
        ...
        <h2 className='home-title text-center font-bold text-[#3b4b3b] text-[1.3rem] sm:text-[1.8rem] md:text-[2.2rem] lg:text-[2.5rem] pb-[2%]'>Small changes, big impact <br/> Go green in your daily routine</h2>
