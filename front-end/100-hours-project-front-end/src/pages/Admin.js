...
<button className='btn btn-primary addingTest' onClick={displayForm}>Add New</button>
{display && <form
...
{allData.map((data) =>(
  <form
      ...
      <TagsInput  className="mt-2 border border-gray-400 p-2 w-full" value={data.Tags[0].split(",")} onChange={(e)=> updateTags(e, data._id)} />
    </td>
    <button
